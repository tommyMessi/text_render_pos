...
def parse_args():
    ...
    parser.add_argument('--num_img', type=int, default=500000, help="Number of images to generate")
    ...
    parser.add_argument('--chars_file', type=str, default='./data/chars/chars.txt',
    ...
    parser.add_argument('--fonts_list', type=str, default='./data/fonts_list/chn_list.txt',
    ...
    parser.add_argument('--corpus_dir', type=str, default="./data/corpus/chn",
    ...
    parser.add_argument('--tag', type=str, default='training_eng', help='output images are saved under output_dir/{tag} dir')
